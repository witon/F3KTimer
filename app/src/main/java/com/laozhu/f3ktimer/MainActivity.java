...
import com.laozhu.f3ktimer.databinding.ContentMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ActivityMainBinding activityMain2Binding = DataBindingUtil.setContentView(this, R.layout.activity_main);
        Competition competition = getApp().competitionArrangement.getCompetition();
        //activityMain2Binding.setCompetition(competition);
        ContentMainBinding contentMainBinding = DataBindingUtil.setContentView(this, R.layout.content_main);
        contentMainBinding.setCompetition(competition);
